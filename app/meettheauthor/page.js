				...
				<div class='w-full bg-white rounded-lg overflow-hidden shadow-lg flex flex-col md:flex-row'>
					...
					<div class='w-full md:w-3/5 flex flex-col justify-center mb-6'>
						...
						<p class='text-center mb-6 px-6'>
							...
							in Dianbai, Guangdong, China. She grew up in the United States and
							went on to graduate magna cum laude from the University of
							Nebraska at Omaha with a Bachelor of Science in biotechnology with
							a minor in chemistry while participating in multiple research
							fellowships. After working in the pharmaceutical industry, Sara
							decided to change careers and is an aspiring genetic counselor.
							Her goal is to support families created through adoption during
