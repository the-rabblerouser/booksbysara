				...
				<div className='flex justify-center items-center'>
					<div className='w-full overflow-hidden shadow-lg flex flex-col md:flex-row bg-violet-100'>
						<div className='w-full md:w-3/5 flex flex-col justify-center mb-6 text-grey-300'>
							...
							<p
								className={`${montserrat.className} text-center md:text-sm mb-3 lg:mb-6 px-[0.5rem] lg:px-[4.9rem] xlg:mx-[5.0rem] tracking-widest`}>
							...
							<p
								className={`${montserrat.className} text-center md:text-sm lg:mb-6 px-[0.5rem] lg:px-[4.9rem] xlg:mx-[5.0rem] tracking-widest`}>
